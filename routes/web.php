...
Route::get('/hospitalar/recepcao', [RecepcaoController::class, 'index'])->middleware(['auth', 'verified', 'permission:btnRecepcao'])->name('hospitalar.recepcao');
...
Route::get('/entidades/clientes', [ClienteController::class, 'index'])->middleware(['auth', 'verified', 'permission:btnCliente'])->name('clientes.index');
...
Route::get('/entidades/registo', [RegistoController::class, 'index'])->middleware(['auth', 'verified', 'permission:btnCliente'])->name('entidades.registo');
Route::post('/entidades/registo', [RegistoController::class, 'store'])->middleware(['auth', 'verified'])->name('entidades.registo.store');

Route::get('/entidades/pacientes', [PacienteController::class, 'index'])->middleware(['auth', 'verified', 'permission:accordionPacientes'])->name('pacientes.index');
...
Route::get('/entidades/medicos', [MedicoController::class, 'index'])->middleware(['auth', 'verified', 'permission:accordionMedicos'])->name('medicos.index');
...
Route::get('/hospitalar/consultas', [ConsultaController::class, 'index'])->middleware(['auth', 'verified', 'permission:accordionConsultas'])->name('consultas.index');
...
Route::get('/hospitalar/triagem', [TriagemController::class, 'index'])->middleware(['auth', 'verified', 'permission:accordionTriagem'])->name('hospitalar.triagem');
Route::post('/hospitalar/triagem', [TriagemController::class, 'store'])->middleware(['auth', 'verified'])->name('hospitalar.triagem.store');

Route::get('/hospitalar/consultorio', [ConsultorioController::class, 'index'])->middleware(['auth', 'verified', 'permission:accordionConsultorio'])->name('hospitalar.consultorio');
...
Route::get('/hospitalar/consultorio/exames-guia/{id}', [ConsultorioController::class, 'getExamesGuia'])->middleware(['auth', 'verified'])->name('hospitalar.consultorio.exames.guia');

Route::get('/hospitalar/seguradoras', [SeguradoraController::class, 'index'])->middleware(['auth', 'verified', 'permission:accordionSeguradora'])->name('hospitalar.seguradoras');
...
Route::get('/hospitalar/exames', [ExameController::class, 'index'])->middleware(['auth', 'verified', 'permission:accordionExames'])->name('hospitalar.exames');
...
Route::get('/hospitalar/servicos', [ServicoController::class, 'index'])->middleware(['auth', 'verified', 'permission:accordionServicos'])->name('hospitalar.servicos');
...
Route::get('/hospitalar/enfermaria', [EnfermariaController::class, 'index'])->middleware(['auth', 'verified', 'permission:accordionEnfermaria'])->name('hospitalar.enfermaria.index');
...
Route::get('/hospitalar/internamento', [InternamentoController::class, 'index'])->middleware(['auth', 'verified', 'permission:accordionInternamento'])->name('hospitalar.internamento.index');
...
Route::get('/hospitalar/laboratorio', [LaboratorioController::class, 'index'])->middleware(['auth', 'verified', 'permission:accordionLaboratorio'])->name('hospitalar.laboratorio.index');
...
Route::get('/hospitalar/raiox', [RaioXController::class, 'index'])->middleware(['auth', 'verified', 'permission:accordionRaioX'])->name('hospitalar.raiox.index');
...
Route::get('/configuracoes/empresa', [EmpresaSettingsController::class, 'index'])->middleware(['auth', 'verified', 'permission:btnEmpresa'])->name('configuracoes.empresa.index');
...
Route::get('/configuracoes/utilizadores', [\App\Http\Controllers\Configuracoes\UtilizadorController::class, 'index'])->middleware(['auth', 'verified', 'permission:accordionUtilizadores'])->name('configuracoes.utilizadores.index');
...
Route::get('/configuracoes/permissoes', [\App\Http\Controllers\Configuracoes\PermissaoController::class, 'index'])->middleware(['auth', 'verified', 'permission:accordionPermissoes'])->name('configuracoes.permissoes.index');
